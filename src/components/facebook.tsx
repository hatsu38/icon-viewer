        ...
        <div className="flex-1">
          <div className="flex flex-col">
            ...
            <div className="flex items-center space-x-2">
              <span className="text-gray-500 dark:text-gray-400 text-sm">20時間</span>
              <Icon icon="faEarthAfrica" size="0.8rem" className="text-gray-500 dark:text-gray-400" />
            </div>
          </div>
          <p className="mt-2">
            <span className="word-break">{postText}…</span>
            <span className="text-blue-600 dark:text-blue-400 cursor-pointer">さらに表示</span>
          </p>
          <div className="flex mt-4 space-x-1">
            ...
            <span className="text-gray-500 dark:text-gray-400 ml-2">他{like}件</span>
          </div>
